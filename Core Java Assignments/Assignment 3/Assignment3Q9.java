...
public class Assignment3Q9 {
	public static void main(String[] args) {
		...
		SavingAccount sAccount1 = new SavingAccount(2000.70, 2, "Niall", true);
		SavingAccount sAccount2 = new SavingAccount(2130.16, 1, "Liam", false);
		SavingAccount sAccount3 = new SavingAccount(2900.60, 3, "Louis", true);
