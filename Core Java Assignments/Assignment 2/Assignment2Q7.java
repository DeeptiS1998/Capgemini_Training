...
public class Assignment2Q7 {
	...
	private void addItemsOperation(int choice) {
		...
		case 1:
			...
			System.out.println(candy.count + " candies are added");
			break;
		case 2:
		...
		case 3:
			...
			System.out.println("How many iceCreams you want to add?");
			int iceCreams = sc.nextInt();
			sc.close();
			iceCream.addIceCreams(iceCreams);
		default:
			System.out.println("Your input is invalid. Please enter the correct choice");
			roles(role);
		}
